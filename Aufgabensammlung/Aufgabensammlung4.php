...
<php>
  <?php
    ...
    if(isset($_SESSION['login']) && $_SESSION['login'] == true){
      header('Location: ./Aufgabensammlung4Logged.php');
    }
   ?>
  <head>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-12 text-center">
                      Login
                       <form class="form" role="form" method="POST" action="../PHP/Login.php">
                          ...
                          <div class="form-group">
                            <input type="hidden" name="page" value="../Aufgabensammlung/Aufgabensammlung4Logged.php">
...
<footer class="footer">
  <div class="container text-center">
   ...
   <form class="stilSwitcher pull-right" id="stilSwitcher" action="../StilSwitcher.php" method="get">
     <input type="hidden" name="page" value="./Aufgabensammlung/Aufgabensammlung4.php">
